...
{
    //route qui permet de valider le panier et tout push en base de donnée 
    ...
    public function valide(SessionInterface $session,ManagerRegistry $doctrine)
    {
        ...
        // Creation d'une variable afin de calculer le total
        $total=0;
        // boucle afin des crée les lineorder de la commande 
    ...
    // route qui permet ajouter les produits et  leurs quantités au panier 
    ...
    {
        // destruction de la session cart pour vider le panier 
        $session->set('cart',[]);
        return $this->render('cart/error.html.twig', [
